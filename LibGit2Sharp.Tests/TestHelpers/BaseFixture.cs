...
namespace LibGit2Sharp.Tests.TestHelpers
{
    public class BaseFixture : IPostTestDirectoryRemover, IDisposable
    {
        ...
        public static string SubmoduleUpdateTestRepoWorkingDirPath { get; private set; }
        ...
        private static void SetUpTestEnvironment()
        {
            ...
            SubmoduleUpdateTestRepoWorkingDirPath = Path.Combine(ResourcesDirectory.FullName, "submodule_update_wd");
        }
        ...
        public string CloneSubmoduleUpdateTestRepo()
        {
            return Clone(SubmoduleUpdateTestRepoWorkingDirPath);
        }
